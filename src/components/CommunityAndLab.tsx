    ...
    >
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8 md:gap-10 items-start">
        ...
        <article className="space-y-3">
          ...
          <p className="font-[Tenor_Sans] italic text-[#2C2D2E]/75 text-sm leading-relaxed line-clamp-3">
            {t.laAmistad.body}
          </p>
        ...
        <article className="space-y-3">
          ...
          <p className="font-script text-[#9B1B47] text-lg leading-tight">
          ...
          <p className="font-[Jost] text-[10px] tracking-[0.2em] uppercase text-[#2C2D2E]/50 mt-3">
